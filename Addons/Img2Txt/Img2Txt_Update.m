function [UpdateState] = Img2Txt_Update(varargin)
%
...
[onlineVersion,flag] = urlread('http://www.xmaptools.com/FTP_addons/Img2Txt/Program_version.php');
[onlinePackage,flag2] = urlread('http://www.xmaptools.com/FTP_addons/Img2Txt/Program_package.php');
