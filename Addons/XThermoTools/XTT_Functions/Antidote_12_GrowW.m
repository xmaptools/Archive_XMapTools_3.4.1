...
x_wsize=floor(((xLength/2)-1)/(x_stepsize-1));
y_wsize=floor(((yLength/2)-1)/(x_stepsize-1));
xul=floor((xLength/2)-1);
yul=floor((yLength/2)-1);
xur=floor((xLength/2)+1);
yur=floor((yLength/2)-1);
xbr=floor((xLength/2)+1);
ybr=floor((yLength/2)+1);
xbl=floor((xLength/2)-1);
ybl=floor((yLength/2)+1);
