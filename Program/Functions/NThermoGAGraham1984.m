function [T,lnKd, XCa_Gar] = NThermoGAGraham1984(Data,handles,InputVariables)
% -
% XMapTools external function
%
% This function calculates the Temperature for a garnet-amphibole assemblage 
% using the method of Graham & Powell, 1984. 
%
% [Values] = NThermoGAGraham1984(Data);
%
...
% Graham & Powell (1984)
T = (2880+3280*XCa_Gar)/(lnKd + 2.426) - 273.15;
