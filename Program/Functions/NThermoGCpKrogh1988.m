function [T, Pressure, lnKd] = NThermoGCpKrogh1988(Data,handles,InputVariables)
% -
% XMapTools external function
%
% This function calculates the Temperature for a garnet-cpx assemblage 
% using the method of Krogh (1988). 
%
% [Values] = NThermoGCpKrogh1988(Data);
%
...
%
% Setup : 
% 2>Garnet+Clinopyroxene>T- Krogh 1988>NThermoGCpKrogh1988>T P lnKd>SiO2 TiO2 Al2O3 FeO MnO MgO CaO Na2O K2O>
%
% 6 Oxygens for cpx
...
% Krogh (1988)
T = (-6173*Xgrs^2 + 10*Pressure + 6731*Xgrs + 1879) / (lnKd + 1.393) - 273.15;
