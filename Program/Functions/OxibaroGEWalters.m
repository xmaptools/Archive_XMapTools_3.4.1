function [logfO2] = OxibaroGEWalters(Data,handles,InputVariables)
% -
...
%
%
% Created by Jesse Walters and implemented by P. Lanari (Last change: 03.12.2019)
% -
...
logfO2=(1/(2.303*R*TK))*((G_O2-G_O2_0)/1000)+log10(a_O2);
