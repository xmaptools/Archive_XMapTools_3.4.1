function [T,lnKd] = NThermoGCpMysen1972(Data,handles,InputVariables)
% -
% XMapTools external function
%
% This function calculates the Temperature for a garnet-cpx assemblage 
% using the method of Mysen & Heier (1972). 
%
% [Values] = NThermoGCpMysen1972(Data);
%
...
%
% Setup : 
% 2>Garnet+Clinopyroxene>T- Mysen&Heier 1972>NThermoGCpMysen1972>T lnKd>SiO2 TiO2 Al2O3 FeO MnO MgO CaO Na2O K2O>
%
% 6 Oxygens for cpx
