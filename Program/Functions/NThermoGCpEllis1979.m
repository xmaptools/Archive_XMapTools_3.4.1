function [T,lnKd] = NThermoGCpEllis1979(Data,handles,InputVariables)
% -
% XMapTools external function
%
% This function calculates the Temperature for a garnet-cpx assemblage 
% using the method of Ellis & Green (1979). 
%
% [Values] = NThermoGCpEllis979(Data);
%
...
%
% Setup : 
% 2>Garnet+Clinopyroxene>T- Ellis&Green 1979>NThermoGCpEllis1979>T lnKd>SiO2 TiO2 Al2O3 FeO MnO MgO CaO Na2O K2O>
%
% 6 Oxygens for cpx
...
% Ellis & Green (1979)
T = (3104*Xgrs+3030+10.86*Pressure)/(lnKd + 1.9034) - 273.15;
