function [T, Pressure, lnKd] = NThermoGCpDahl1980(Data,handles,InputVariables)
% -
% XMapTools external function
%
% This function calculates the Temperature for a garnet-cpx assemblage 
% using the method of Dahl (1980). 
%
% [Values] = NThermoGCpDahl1980(Data);
%
...
%
% Setup : 
% 2>Garnet+Clinopyroxene>T- Dahl 1980>NThermoGCpDahl1980>T P lnKd>SiO2 TiO2 Al2O3 FeO MnO MgO CaO Na2O K2O>
%
% 6 Oxygens for cpx
...
Kd = (Xalm*(Mg_Cpx/(Fe_Cpx+Mg_Cpx)))/(Xpyr*(Fe_Cpx/(Fe_Cpx+Mg_Cpx)));
lnKd = log(Kd);

% Dahl (1980)
T = (2324 + 0.022*Pressure*1000 + 1509*Xalm*Xpyr + 2810*Xgrs + 2855*Xspe) / (1.987 * lnKd) - 273.15;
