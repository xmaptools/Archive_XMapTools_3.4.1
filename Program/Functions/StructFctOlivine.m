function [Si_t Fe_t Mg_t Mn_t Fo Fa Tep] = StructFctOlivine(Data,handles)
% -
% XMapTools External Function: Structural formula of olivine
%
%   [outputs] = function_Name(Data,handles);
%
%   1>Olivine>Oliv-StructForm>StructFctOlivine>Si Fe Mg Mn Fo Fa Tep>SiO2 TiO2 
...
Fo = zeros(1,length(Data(:,1)));
Fa = zeros(1,length(Data(:,1)));
Tep = zeros(1,length(Data(:,1)));
