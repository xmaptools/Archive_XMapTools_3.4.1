function [T, Pressure, lnKd] = NThermoGCpAi1994(Data,handles,InputVariables)
% -
% XMapTools external function
%
% This function calculates the Temperature for a garnet-cpx assemblage 
% using the method of Ai (2000). 
%
% [Values] = NThermoGCpAi1994(Data);
%
...
%
% Setup : 
% 2>Garnet+Clinopyroxene>T- Ai 1994>NThermoGCpAi1994>T P lnKd>SiO2 TiO2 Al2O3 FeO MnO MgO CaO Na2O K2O>
%
% 6 Oxygens for cpx
...
XMg_Gar = Mg_Gar/(Fe_Gar+Mg_Gar);                % removed 100*Mg... P. Lanari (22.12.13)

Kd = (Fe_Gar/Mg_Gar)/(Fe_Cpx/Mg_Cpx);
lnKd = log(Kd);

T = (-1629*XCa_Gar^2 + 3648.55*XCa_Gar - 6.59*XMg_Gar + 1987.98 + 17.66*Pressure)/(lnKd + 1.076) - 273.15;
