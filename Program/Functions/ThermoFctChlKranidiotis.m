function [T,Al4] = ThermoFctChlKranidiotis(Data,handles)
% -
...
% of chlorites, using the thermometer of Kranidiotis & MacLean, 1987.
%
% [Temp,Aliv] = ThermoFctKranidiotis(Data);
%
...
%
% Setup : 
% Chlorite-Kranidiotis & MacLean, 1987-ThermoFctKranidiotis-T Al4-SiO2 Al2O3 FeO MnO MgO CaO Na2O K2O-
%
...
for i=1:length(Data(:,1)) % one by one
    ...
    if OnCal
        ...
        % Kranidiotis & MacLean, (1987)
        Aliv = 4 - Si;
        Aliv = Aliv * 2;
        
        FeMg = (Fe*2)/((Fe*2)+(Mg*2));
        
        AlivCorr = Aliv + 0.7*(FeMg);
