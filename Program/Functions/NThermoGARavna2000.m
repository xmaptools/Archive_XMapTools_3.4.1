function [T,XCaGrt,XMnGrt,lnKd] = NThermoGARavna2000(Data,handles,InputVariables)
% -
...
%
% [Values] = NThermoGARavna2000(Data);
%
...
XCaGrt = Ca_Gar/(Ca_Gar + Mn_Gar + Fe_Gar + Mg_Gar);
XMnGrt = Mn_Gar/(Ca_Gar + Mn_Gar + Fe_Gar + Mg_Gar);

% Ravna (2000)
T = (1504 + 1784*(XCaGrt+XMnGrt))/(lnKd+0.720) - 273.15;
