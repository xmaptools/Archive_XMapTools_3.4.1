function [T, Pressure, lnKd] = NThermoGCpGanguly1979(Data,handles,InputVariables)
% -
% XMapTools external function
%
% This function calculates the Temperature for a garnet-cpx assemblage 
% using the method of Raheim & Green (1974). 
%
% [Values] = NThermoGCpGanguly1979(Data);
%
...
%
% Setup : 
% 2>Garnet+Clinopyroxene>T- Ganguly 1979>NThermoGCpGanguly1979>T P lnKd>SiO2 TiO2 Al2O3 FeO MnO MgO CaO Na2O K2O>
%
% 6 Oxygens for cpx
...
% Ganguly (1979)
T = (4801 + 11.07*Pressure + 1586*Xgrs + 1308*Xspe) / (lnKd + 2.93) - 273.15;
