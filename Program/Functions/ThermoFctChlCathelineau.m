function [T,Al4] = ThermoFctChlCathelineau(Data,handles)
% -
...
%
% Setup : 
% Chlorite-Cathelineau, 1988-ThermoFctCathelineau-T Al4-SiO2 Al2O3 FeO MnO
% MgO CaO Na2O K2O-
%
...
for i=1:length(Data(:,1)) % one by one
    ...
    if OnCal
        ...
        % Cathelineau, 1988 (14 OX)
        Aliv = 4 - Si;
        
        T(i) = -61.9229 + 321.9772 * Aliv;
        Al4(i) = Aliv;
