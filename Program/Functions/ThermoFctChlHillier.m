function [T,Al4] = ThermoFctChlHillier(Data,handles)
% -
...
% of chlorites, using the thermometer of Hillier & Velde 1990.
%
% [Temp,Aliv] = ThermoFctHillier(Data);
%
...
%
% Setup : 
% Chlorite-Hillier & Velde, 1990-ThermoFctHillier-T Al4-SiO2 Al2O3 FeO MnO
% MgO CaO Na2O K2O-
%
...
for i=1:length(Data(:,1)) % one by one
    ...
    if OnCal
        ...
        % Hillier & Velde, 1990 (28 OX !!!)
        Aliv = 4 - Si;
        Aliv = Aliv * 2;
        
        T(i) = (Aliv - 1.303546) / 0.004007;
        Al4(i) = Aliv/2; % 14 Oxygens
