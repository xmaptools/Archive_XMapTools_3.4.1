...
% 14 Oxygens
%
% Created by P. Lanari (Juillet 2012) - TESTED & VERIFIED 01/09/12.
...
Fe3Per = 0;
[lesData] = str2num(char(inputdlg({'Fe3+ (0-50%)','Pressure (kbar)'},'Input',1,{'0','5'})));
Fe3Per = lesData(1);
Pressure = lesData(2);
...
for i=1:length(Data(:,1)) % one by one
    ...
    if OnCal
        ...
        if z > 0.07
            T(i) = (A+B*Pressure)/(-R*lnK-C) - 273.15;
        else
            T(i) = 0;
        end
