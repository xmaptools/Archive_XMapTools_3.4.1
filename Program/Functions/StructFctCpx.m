function [Si_T1,Al_T1,XMg,XFe,Al_M1,Mg_M1,Fe_M1,Ca_M2,Na_M2,XJd,XDi,XHd,XCats,Xsum,SumM1,SumM2] = StructFctCpx(Data,handles)
% -
...
for i = 1:length(Data(:,1)) % one by one
    ...
    if OnCal
        ...
        Xsum(i) = XHd(i)+XJd(i)+XDi(i)+XCats(i);
