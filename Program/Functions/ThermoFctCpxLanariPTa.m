function [P,T] = ThermoFctCpxLanariPTa(Data,handles)
% -
% XmapTools Function (version 1.5)
% Use this function only with XmapTools 1.5.
%
% LANARI function for Cpx+Garnet+Phengite
% T was estimated with Ellis & Green (1979) between omphacite and garnet
...
%
% Setup : 
% 1>Clinopyroxene>Cpx-P-T E&G (Cpxp-Grt-Phg)>ThermoFctCpxLanariPTa>P 
%   T>SiO2 TiO2 Al2O3 FeO MnO MgO CaO Na2O K2O>
%
%
% 6 Oxygens
%
% Created by P. Lanari (Octobre 2011) - TESTED & VERIFIED 16/06/12.
...
for i=1:length(Data(:,1)) % one by one
    ...
    if OnCal
        ...
        % Temperature estimates (Hellis & Green, 1979)
        ...
        T1 = HGTempFromPressure(XCa_gar,P1,Kd_cg);
        ...
        T2 = HGTempFromPressure(XCa_gar,P2,Kd_cg);
