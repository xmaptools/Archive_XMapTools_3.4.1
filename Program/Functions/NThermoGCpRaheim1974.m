function [T, Pressure, lnKd] = NThermoGCpRaheim1974(Data,handles,InputVariables)
% -
...
%
% [Values] = NThermoGCpRaheim1974(Data);
%
...
%
% Setup : 
% 2>Garnet+Clinopyroxene>T- Raheim&Green 1974>NThermoGCpRaheim1974>T P lnKd>SiO2 TiO2 Al2O3 FeO MnO MgO CaO Na2O K2O>
%
% 6 Oxygens for cpx
...
% Raheim & Green (1974)
T = (3686 + 28.35*Pressure) / (lnKd + 2.33) - 273.15;
