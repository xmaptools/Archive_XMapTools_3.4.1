function [Si,Ti,Al,V,Cr,Fe3,Fe2,Mn,Mg,Ca,H2,SumTetra,SumOcta,SumDod,SumCharges_vect,FeO,Fe2O3,Total] = StructFctGarnetH2O_MoSub(Data,handles)
% -
% XMapTools External Function: Structural formula of Garnet (including Fe3+ estimate)
%
%   [outputs] = function_Name(Data,handles);
%
%   1>Garnet_H2O>Grt_Meth3-MoroiteSub>StructFctGarnetH2O_MoSub>Si Ti Al V Cr Fe3 Fe2 Mn Mg 
...
%
%   *** Method 3 ***    
%   MoSub (Fe3+ is approximated on the basis of Sum(Charges) = 24; 
%   Fe2+ goes on Octahedral site)
%
%
