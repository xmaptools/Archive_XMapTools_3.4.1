function [T, Pressure, lnKd] = NThermoGCpPowell1985(Data,handles,InputVariables)
% -
% XMapTools external function
%
% This function calculates the Temperature for a garnet-cpx assemblage 
% using the method of Powell (1985). 
%
% [Values] = NThermoGCpPowell1985(Data);
%
...
%
% Setup : 
% 2>Garnet+Clinopyroxene>T- Powell 1985>NThermoGCpPowell1985>T P lnKd>SiO2 TiO2 Al2O3 FeO MnO MgO CaO Na2O K2O>
%
% 6 Oxygens for cpx
...
% Powell (1985)
T = (2790 + 10*Pressure + 3140*Xgrs) / (lnKd + 1.735) - 273.15;
